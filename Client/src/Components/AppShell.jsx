    ...
    >
        {({ isActive }) => (
            <>
                ...
                {!collapsed && (
                    <span
                        className={`${appShellStyles.sidebarText} ${isActive
                            ? appShellStyles.sidebarTextActive
                            : appShellStyles.sidebarTextInactive
                            }`}
                    >
                        {children}
                    </span>
...
// Icon components defined outside to avoid render-time creation
