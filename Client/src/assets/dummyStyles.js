...
export const appShellStyles = {
  ...
  logoTextContainer: "",
  logoText: "font-bold pt-sans-regular text-3xl bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent",
  ...
  mobileLogoText: "font-bold pt-sans-regular text-xl ml-3 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent",
...
export const heroStyles = {
  ...
  // Decorative Accents
  cornerAccent1:
    "hidden sm:block absolute -top-2 -right-2 w-5 h-5 sm:w-6 sm:h-6 border-t-2 border-r-2 border-blue-500 rounded-tr-2xl sm:rounded-tr-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  cornerAccent2:
    "hidden sm:block absolute -bottom-2 -left-2 w-5 h-5 sm:w-6 sm:h-6 border-b-2 border-l-2 border-indigo-500 rounded-bl-2xl sm:rounded-bl-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500",
...
export const pricingStyles = {
  ...
  badgeDot: "w-2 h-2 bg-blue-500 rounded-full mr-2 animate-pulse",
  badgeText: "text-sm font-medium text-blue-700",
  title: "text-center text-2xl md:text-5xl lg:text-5xl xl:text-5xl font-bold text-gray-900 tracking-tight mb-6",
  ...
  // Billing Toggle
  billingToggle: "inline-flex items-center justify-center mx-auto bg-white/80 backdrop-blur-sm rounded-2xl p-2 border border-gray-200/60 shadow-sm",
  ...
  // Pricing Grid
  grid: "mt-12 lg:mt-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-10 lg:gap-6 relative",
...
export const navbarStyles = {
  ...
  logoText: "font-semibold pt-sans-regular text-lg tracking-tight",
