...
const Dasboard = () => {
            ...
            if (data) {
                ...
                if (data.subscriptionEndDate) {
                    ...
                    if (Date.now() > endDate.getTime()) {
                        // Redirect to pricing page with a query char
    ...
    }, [fetchInvoice, fetchBusinessProfile, isSignedIn]);
        ...
        <div className={dashboardStyles.pageContainer}>
            <div className={dashboardStyles.headerContainer}>
                ...
                <p className={dashboardStyles.headerSubtitle}>
                    Track your invoicing performance and business insights with AI Billing
                </p>
            </div>

            {/*----LOADING ERROR STATE----*/}
            {loading ? (
                <div className='p-6 flex justify-center items-center text-xl text-gray-500'>Loading Invoice...</div>
            ) : error ? (
                <div className='p-6'>
                    <div className='text-red-500'>Error: {error}</div>
                    <div className='flex gap-2'>
                        <button onClick={fetchInvoice} className='mt-2 text-blue-600 hover:underline'>Retry</button>
                        {String(error).toLocaleLowerCase().includes("unauthorized") && (
                            <button onClick={() => navigate('/login')} className='px-3 py-1 bg-gray-700 text-white rounded-md mt-2 hover:bg-gray-600'>Sign In</button>
                        )}
                    </div>
                </div>
            ) : null
                        ...
                        <div className={dashboardStyles.quickStatsCard}>
                            ...
                            <div className='space-y-3'>
                                ...
                                <div className={dashboardStyles.quickStatsRow}>
                                    ...
                                    <span className={dashboardStyles.quickStatsValue}>
                                        {currencyFmt(kpis.totalInvoices > 0 ? (kpis.totalPaid + kpis.totalUnpaid)
                                            / kpis.totalInvoices : 0, 'INR')}
                                    </span>
                                </div>
                                <div className={dashboardStyles.quickStatsRow}>
                                    <span className={dashboardStyles.quickStatsLabel}>
                    ...
                    <div className={dashboardStyles.cardContainerOverflow}>
                            ...
                            <div className={dashboardStyles.tableHeaderContent}>
                                <div>
                                    ...
                                    <p className={dashboardStyles.tableSubtitle}>
                                        Latest 5 Invoice from your Account
                                    </p>
                                </div>
                        ...
                        <div className={dashboardStyles.tableContainer}>
                            <table className={dashboardStyles.table}>
                                <thead>
                                    <tr className={dashboardStyles.tableHeader}>
                                            ...
                                            <tr key={inv.id} className={dashboardStyles.tableRow}
                                                ...
                                                <td className={dashboardStyles.tableCell}>
                                                    <div className='flex items-center gap-3'>
                                                        <div className={dashboardStyles.clientAvatar}></div>
                                                        {clientInitial}
                                                    </div>
                                                    <div>
                                                ...
                                                <td className={dashboardStyles.tableCell}>
                                                    <div className={dashboardStyles.dateCell}>
                                                        {inv.dueDate ? formatDate(inv.dueDate) : "_"}
                                                    </div>
                                        ...
                                        <tr>
                                            <td colSpan="5" className={dashboardStyles.emptyState}>
                                                ...
                                                <button onClick={() => navigate('/app/create-invoice')}
                                                    className={`mt-4 ${dashboardStyles.emptyStateAction}`}
                                                >
